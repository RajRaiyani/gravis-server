...
export async function Controller(
  ...
  const customer = await db.queryOne(`--sql
    INSERT INTO customers (first_name, last_name, email, password_hash, phone_number, is_phone_number_verified)
    VALUES ($1, $2, $3, $4, $5, true)
    RETURNING id, first_name, last_name, full_name, email, phone_number, is_phone_number_verified, created_at
    `,
  [
    tokenData.first_name,
    tokenData.last_name,
    `${tokenData.phone_number}@phone.gravis.local`,
    passwordHash,
